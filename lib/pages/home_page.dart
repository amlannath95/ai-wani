...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan(){
    AlanVoice.addButton(
        "85d1bd96e5a4f882c0bb7aa5d22d90a92e956eca572e1d8b807a3e2338fdd0dc/stage",
        ...
        children: [
          VxAnimatedBox()
            ...
            begin: Alignment.topLeft, end: Alignment.bottomRight,
              ...
              .make(),
          [AppBar(
            title: "AI - Wani".text.xl4.bold.white.make().shimmer(
          ...
          radios != null ? VxSwiper.builder(
            ...
            itemBuilder: (context, index){
              ...
              ).clip(Clip.antiAlias).bgImage(DecorationImage(image: NetworkImage(rad.image),
              fit: BoxFit.cover,
